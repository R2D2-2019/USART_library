...
uint8_t hardware_usart_c::receive_byte() { return hardware_usart->US_RHR; }
...
void hardware_usart_c::putc(char c) { send_byte(c); }
...
bool hardware_usart_c::char_available() { return (available() > 0); }
